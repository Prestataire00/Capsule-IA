...
--   0147  émargement (audit) : pause déjeuner, liens tracés par canal, sortie
--         attestée, formateurs marquables, feuilles de groupe comptées pour
--         Qualiopi, heures Zoom réelles, tâches programmées par la base (pg_cron)
--   0148  émargement en salle (modèle Edusign) : QR code dynamique projeté,
--         lien lié au téléphone qui scanne, signature enregistrée en mode « qr »
--   0149  émargement : justificatifs d'absence (dépôt apprenant ou équipe,
--         décision de l'équipe), seau privé, lecture réservée
--
...
-- ───────────── 0149_emargement_justificatifs.sql ─────────────
