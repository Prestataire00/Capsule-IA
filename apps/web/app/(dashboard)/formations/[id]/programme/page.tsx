...
export default async function ProgrammeEditPage({ params }: { params: { id: string } }) {
  ...
  const formation: ProgrammeFormation = {
    ...
    referentContactEmail: str('referentContactEmail'),
    referentContactPhone: str('referentContactPhone'),
    referentHandicap: str('referentHandicap'),
    referentHandicapEmail: str('referentHandicapEmail'),
    referentHandicapPhone: str('referentHandicapPhone'),
