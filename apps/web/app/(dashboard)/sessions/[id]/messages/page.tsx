              ...
              <li key={s.id} className="px-4 py-3 flex items-center justify-between gap-3">
                <span className="min-w-0 flex items-center gap-2.5">
                  ...
                  <span className="min-w-0">
                    ...
                    {!s.isPublished && (
                      <span className="block text-[12px] text-zinc-500">Brouillon — pas encore visible des participants</span>
                    )}
                  </span>
                </span>
                {s.url && (
                  <a
                    ...
                    className="text-[12px] font-medium text-orange-600 dark:text-orange-400 hover:underline flex-shrink-0"
                  >
                    Ouvrir
                  </a>
                )}
