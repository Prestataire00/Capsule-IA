...
import { publierTravail, supprimerTravailFormateur, type Ancrage } from './actions';
...
export function TravailActions({
  ...
  return (
    <div className="flex items-center gap-1.5 flex-shrink-0">
      ...
      <button
        type="button"
        onClick={() => agir(() => publierTravail({ ancrage, travailId, publier: !publie }))}
        disabled={pending}
      ...
      <button
        ...
        onClick={() => {
          ...
          agir(() => supprimerTravailFormateur({ ancrage, travailId }));
        }}
        disabled={pending}
        title="Supprimer"
