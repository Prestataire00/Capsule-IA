  ...
  return (
    <>
      <button
        ...
        className="w-full max-w-md h-9 bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 rounded-lg px-3 flex items-center gap-2 hover:border-zinc-300 dark:hover:border-zinc-700 transition text-left"
      >
      ...
      {open && (
        ...
        >
          <div
            className="w-full max-w-lg bg-white dark:bg-zinc-900 border border-zinc-200/70 dark:border-zinc-800 rounded-xl shadow-lg overflow-hidden"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center gap-2 px-3 h-11 border-b border-zinc-200/70 dark:border-zinc-800">
              <Search className="w-3.5 h-3.5 text-zinc-400" />
              <input
                autoFocus
                value={query}
                    ...
                    <li key={s.href}>
                      <Link
                        ...
                        className={cn(
                          ...
                          'group hover:bg-orange-50 dark:hover:bg-orange-950/30 hover:text-orange-700 dark:hover:text-orange-300 text-zinc-700 dark:text-zinc-300 font-medium',
                        )}
                      >
