...
const ERREURS: ReadonlyArray<readonly [string, string]> = [
  ...
  ['justification_type', 'Format non accepté : PDF, JPG, PNG, WEBP ou HEIC.'],
  ['justification_too_large', 'Fichier trop lourd (10 Mo au plus).'],
  ['justification_missing', 'Choisissez un fichier.'],
  ['justification_limit', 'Cinq justificatifs au plus par demi-journée.'],
  ['justification_upload_failed', 'Le justificatif n’a pas pu être enregistré. Réessayez.'],
  ['justification_not_found', 'Justificatif introuvable.'],
  ['justification_already_decided', 'Ce justificatif a déjà été traité.'],
